...
public class RequestItemHolder extends RecyclerView.ViewHolder {
    ...
    private void showOnMapFunc(){
        ...
        LatLng shopLatLng = new LatLng(Double.valueOf(shopLat.getText().toString()), Double.valueOf(shopLng.getText().toString()));
    ...
    private View.OnClickListener acceptRequest = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (hStatus.getText().toString().equalsIgnoreCase("waiting")) {
                ...
                new AlertDialog.Builder(MainActivity.activity).setCancelable(false).setMessage("Are you sure you want to set the request as DELIVERED?")
